let movies = [
  ...
  },
  {
    name: "Oppenheimer",
    poster:
      "https://www.tallengestore.com/cdn/shop/products/Oppenheimer-CillianMurphy-ChristopherNolan-HollywoodMoviePoster.jpg?v=1691369029",
    rating: 9.2,
  },
  {
    name: "Moon Light",
  ...
  },
  {
    ...
    rating: 6.5,
    cast:"Rami Malek . Jhon Jacobs . Emma Stone",
  },
  {
    name: "The Avengers",
    poster:
  ...
  },
  {
    name: "John Wick",
    poster:
      "https://rukminim2.flixcart.com/image/850/1000/k0lbdzk0/poster/4/w/g/medium-john-wick-poster-for-room-office-13-inch-x-19-inch-rolled-original-imafkc6fd8mc6jga.jpeg?q=90",
    rating: 7.9,
  },
  {
    name: "Maleficient",
  ...
  },
  {
    name: "Leo",
    poster:
      "https://m.media-amazon.com/images/I/71c2cxxNQIL._AC_UF894,1000_QL80_.jpg",
    rating: 8.7,
  },
];
...
function searchMovie() {
  ...
  if (movieName !== "") {
    ...
    if (result.length == 0) {
      ...
      displayMovies(result); // Display filtered movies
    }
  } else {
    displayMovies(movies); // If search is empty, show all movies
  }
}
